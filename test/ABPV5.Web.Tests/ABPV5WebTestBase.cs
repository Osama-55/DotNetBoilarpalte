...
{
    public abstract class ABPV5WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ABPV5WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ABPV5WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ABPV5DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ABPV5DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ABPV5DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ABPV5DbContext, Task<T>> func)
        {
            T result;
